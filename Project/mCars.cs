...
namespace Project
{
    public partial class mCars : MetroForm
    {
        public mCars()
        {
            InitializeComponent();
        ...
        private void orderBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string query = "insert into [Order] values (" + UserHelper.UserID + ", " + carID + ", '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "', 'On Process');" +
